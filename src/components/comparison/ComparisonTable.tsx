                ...
                <th key={school.code} className="px-4 py-4 text-center" style={{minWidth: '280px', width: '280px'}}>
                  <div className="space-y-2">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center justify-center px-3 py-1.5 text-xs font-medium text-white bg-pink-600 hover:bg-pink-700 rounded-lg transition-colors duration-200 mt-2"
                    >
